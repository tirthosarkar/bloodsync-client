                        ...
                        <td className="px-3 lg:px-4 py-4">
                          <div className="flex flex-col gap-1 items-start">
                            ...
                            {req.status === 'inprogress' && req.donorName && (
                              <div className="flex items-center gap-1 text-xs text-gray-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100 max-w-[130px] truncate">
                                <FaUser
                  ...
                  >
                    ...
                    <div className="space-y-1 sm:space-y-1.5 text-xs sm:text-sm text-gray-600 mb-3">
                      ...
                      <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 pt-1">
                        ...
                        {req.status === 'inprogress' && req.donorName && (
                          // ── CHANGED: max-w to avoid overflow ──
                          <span className="text-xs text-gray-600 bg-blue-50 px-2 py-1 rounded-md border border-blue-100 flex items-center gap-1 max-w-[150px]">
                            <FaUser
                              className="text-blue-500 shrink-0"
                              size={10}
                            />
                            <span className="truncate">{req.donorName}</span>
                          </span>
                        )}
                      </div>
                    </div>
