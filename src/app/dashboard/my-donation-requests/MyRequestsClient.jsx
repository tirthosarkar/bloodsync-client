                      ...
                      >
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900">
                          <div className="flex flex-col min-w-0">
                            ...
                            <span className="text-xs text-gray-400 xl:hidden mt-0.5 truncate max-w-45">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1.5 items-start">
                            ...
                            {req.status === 'inprogress' && req.donorName && (
                              <div className="flex flex-col items-center gap-1 text-[11px] text-blue-700 bg-blue-50/60 px-2 py-0.5 rounded border border-blue-100 max-w-55">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      ...
                      {req.status === 'inprogress' && req.donorName && (
                        <div className="flex flex-col items-end gap-0.5">
                          <span className="text-[11px] text-gray-500 max-w-37.5 truncate">
                            Donor: {req.donorName}
                          </span>
                          <span className="text-[11px] text-gray-400 max-w-37.5 truncate">
                            {req.donorEmail}
                          </span>
                        </div>
                      )}
